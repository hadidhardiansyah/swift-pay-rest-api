...
public class TransferService {
    ...
    @Transactional
    public TransactionResponse transfer(TransferRequest request, Authentication connectedUser) throws BusinessException, AccessDeniedException {
        ...
        try {
            ...
            transactionService.updateTransactionStatus(newTransaction.getId(), newTransaction.getStatus());
